...
export class TasksController {
    ...
    getTaskById(@Param('id', ParseIntPipe) id: number): Promise<Task> {
        // ParseIntPipe guarantees that ID is a number, built into nestjs, on runtime when handler handles request it parses id paramter to an INT, which is number cause it is a string now. 
        // returns a promise of a task entity.
